...
-- MAGIC %python
-- MAGIC files = dbutils.fs.ls(f"dbfs:/mnt/dbacademy-users/v-ajmaln@microsoft.com/data-engineer-learning-path/sales-csv/")
-- MAGIC display(files)
...
SELECT * FROM binaryfile.`${DA.paths.sales_csv}`
...
CREATE TABLE IF NOT EXISTS sales_csv_table
